...
// RGB shift
const unrealBloomPass = new UnrealBloomPass(RGBShiftShader);
...
// SMAA pass
if (renderer.getPixelRatio() === 1 && !renderer.getRenderTarget.isWebGL2) {
  // support anti-aliasing for older browsers - i.e. Safari < 15
...
const tick = () => {
  ...
  // effect composer will handle passes and rendering objects
  // in screen
